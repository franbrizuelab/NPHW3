...
PARAMETERS = {
    ...
    "SNAKE_P1_CHAR": "●",  # Player 1 snake body
    "SNAKE_P2_CHAR": "○",  # Player 2 snake body
    "SNAKE_P1_HEAD": "◉",  # Player 1 snake head
    "SNAKE_P2_HEAD": "◎",  # Player 2 snake head
    "APPLE_CHAR": "🍎",  # Apple (or use "A" if emoji doesn't work)
    "EMPTY_CHAR": " ",  # Empty cell
    
    # Game settings
    "INITIAL_SNAKE_LENGTH": 3,
    "GAME_SPEED": 0.3,  # Seconds between moves (lower = faster)
